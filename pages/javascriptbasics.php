...
<code-block language="html" label="Пример за променливи" controls>
    <textarea>
        <script>
    var age = 30; //Възрастта е 30 
    let name = "John"; // Тази променлива "let" можем да я сменим с друго име, затова може да се нарича нещо различно
    const pi = 3.14; // Пи винаги е  3.14, използваме "const" за променливи които не би трябвало да се променят 
</script>
    </textarea>
</code-block> 
    ...
    <code-block language="html" label="Пример за булеви резултати" controls>
    <textarea>
        <script>
    var isTrue = true; // Булев израз за лъжа
    let isFalse = false; // Булев израз за истина.
</script>
    </textarea>
</code-block> 
    ...
    <code-block language="html" label="Пример за оператори" controls>
    <textarea>
        <script>
var x = 220;
var y = "Hello";
...
x | | y    // Връща стойността 220 защото първата променлива е верна
        
x | | z   // Връща стойността 220 защото първата променлива е верна
        
x && y    // Връща "Hello" защото и двате променливи са верни
        
y && z   // Връща undefined  защото втората променлива е лъжлива
        
if( x && y ){ 
  console.log("Code runs" ); // Изписва ни резултата
}   
...
if( x || z ){
  console.log("Code runs");  // Изписва ни резултата
    ...
    <code-block language="html" label="Условни оператори" controls>
    <textarea>
        <script>
...
if( dayOfWeek === "Monday" ){
    ...
    <code-block language="html" label="Цикли, обекти и масив пример" controls>
    <textarea>
        <script>
        var visitors = [
            {name: "Дарчо", nickname: "Сладурчо"},
            {name: "Боянчо", nickname: "Манго"},
            {name: "Нещо", nickname: "Смешно"}        
        ];
        ...
        console.log("В клуб " + club.name + " Намиращ се " + club.location + " Имаше голямо парти направено от: ");

        for( var i = 0; i < club.visitors.length; i++ ){
            var visitors = club.visitors[i];

            console.log(" " + visitors.name + ", " + visitors.nickname);
        }
</script>
    </textarea>
</code-block> 
    ...
    <code-block language="html" label="Асинхроно изпълнение" controls>
    <textarea>
        <script>
    function exampleFunction (){
        var functionScopedVar = "Това е функция";

        console.log(functionScopedVar);

        setTimeout(function(){
            let blockScopedVar = "Това е обещание/извикване";
    ...
    <p class="pt-4 fs-6">       
        Този пример илюстрира как JavaScript можем да ползваме ивизквания и да обещаем променливите да бъдат изписани. Първо конзолата веднага ще ни даде текста "Това е функция"  и след това ще се спре за 2000 стотни преди да изпише "Това е обещание/извикване" поселдвана веднага от "Това е функция".
    </p>
