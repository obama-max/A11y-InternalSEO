    	...
    	<div class="container-xl pt-5 pb-5">
    	    <div class="row d-flex justify-content-center">
    	        <div class="col-md-9 border border-2 fs-4 flex-column border-dark d-flex rounded-4 me-2 pb-5 " tabindex="0">
					...
					<p class="pt-4 fs-6">	
						Семантичната достъпност допринася за по-добро разбиране и интерпретиране на уеб сайтовете от страна на потребителите и технологиите за асистенция. При проектирането и разработването на уеб сайтове е важно да се отдели специално внимание на семантичния код, за да се гарантира, че сайтът е разбираем и достъпен за всички потребители.
					</p> 
    	        </div>
